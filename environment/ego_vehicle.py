...
class World(object):
    ...
    def restart(self):
        ...
        self.left_front_radar = FakeRadarSensor(self.player, self.hud, x=2, y=-0.8, z=1.0, yaw=-30.0)
        self.left_back_radar = FakeRadarSensor(self.player, self.hud, x=-3, y=-0.8, z=1.0, yaw=-150.0)
        '''
