...
class World(object):
    ...
    def restart(self):
        ...
        self.left_front_radar = FakeRadarSensor(self.player, self.hud, x=0.5, y=-0.5, z=1.0, yaw=-30.0)
        self.left_back_radar = FakeRadarSensor(self.player, self.hud, x=-1, y=-0.5, z=1.0, yaw=-150.0)
        '''
